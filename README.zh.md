...
- 💻 **CPU / 内存 / 磁盘 / 网络** - 全方位监控
- 🎨 **现代 UI** - 玻璃拟态设计，流畅动画
- 🎭 **主题系统** - 16 款内置主题 + 从 GitHub 安装自定义主题
- 🔐 **安全认证** - JWT 认证保护管理接口
- ⚡ **一键部署** - Docker / 脚本一键安装

## 🎨 主题系统

VStats 支持模块化主题系统，你可以：

- 从 **16 款内置主题** 中选择（午夜科技、赛博朋克、黑客终端等）
- **从 GitHub 安装主题**：`username/repo` 或 `username/repo@v1.0.0`
- **创建自己的主题** 并与社区分享

### 安装自定义主题

1. 进入 **设置** → **主题** → **安装主题**
2. 输入 GitHub 来源：`username/theme-repo`
3. 点击 **安装**

### 创建主题

想要创建自己的主题？请查看 [主题开发指南](docs/THEME-DEVELOPMENT.zh.md)。

主题模板：[`docs/theme-template/`](docs/theme-template/)
